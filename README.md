...
A base atual e `1.2.0` (`1.2.0.0` no manifesto). Ela preserva o baseline `1.1.13` de XMA/XContent/SVOD no UWP, mantem a correcao geral no loader XEX/XDL e adiciona configs padrao por jogo com logging de FPS para diagnostico.
...
```text
xenia-canary-uwp\AppPackages\xenia-canary-uwp\xenia-canary-uwp_1.2.0.0_Debug_Test\xenia-canary-uwp_1.2.0.0_x64_Debug.appxbundle
```
