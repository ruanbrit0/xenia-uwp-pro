...
A base atual e `1.3.0` (`1.3.0.0` no manifesto). Esta versao preserva o baseline `1.1.13` de XMA/XContent/SVOD no UWP, mantem a correcao geral no loader XEX/XDL e adiciona melhorias no frontend UWP para idioma, configuracoes e diagnostico. Ainda ha lags e FPS baixo; compatibilidade e desempenho continuam experimentais.
